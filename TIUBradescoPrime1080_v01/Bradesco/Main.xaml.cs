    ...
    public partial class Main : UserControl
    {
        ...
        public Main()
        {
            ...
            if(prime != "true")
            {
                ...
                btnAjuda.Margin = new Thickness() { Bottom = 280, Left = 450, Right = 461, Top = 1391 };
	    ...
	    {
		    btnTarifasPF.RenderTransform = new TranslateTransform { X = -100 };
		    btnTarifasPJ.RenderTransform = new TranslateTransform { X = -300 };
		    btnInss.RenderTransform = new TranslateTransform { X = -500 };
		    btnCanaisAcesso.RenderTransform = new TranslateTransform { X = -100 };
			btnFundosInvestimento.RenderTransform = new TranslateTransform { X = -300 };
			btnInformativoPublico.RenderTransform = new TranslateTransform { X = -500 };
		    btnPortabilidade.RenderTransform = new TranslateTransform { X = -100 };
			btnProcon.RenderTransform = new TranslateTransform { X = -300 };
			btnInfoCredito.RenderTransform = new TranslateTransform { X = -500 };
		    btnFolheto.RenderTransform = new TranslateTransform { X = -100 };
			btnPrime.RenderTransform = new TranslateTransform { X = -300 };
			btnAjuda.RenderTransform = new TranslateTransform { X = -500 };
	    }
