    ...
    public partial class Principal : UserControl
    {
        ...
        public Principal()
        {
            ...
            if (prime != "true")
            {
                ...
                btn1.Margin = new Thickness() { Left = 22, Bottom = 0, Right = 0, Top = 1730 };
                btn2.Margin = new Thickness() { Left = 133, Bottom = 0, Right = 0, Top = 1730 };
                btn3.Margin = new Thickness() { Left = 236, Bottom = 0, Right = 0, Top = 1730 };
                btn4.Margin = new Thickness() { Left = 341, Bottom = 0, Right = 0, Top = 1730 };
                btn5.Margin = new Thickness() { Left = 440, Bottom = 0, Right = 0, Top = 1730 };
                btn6.Margin = new Thickness() { Left = 543, Bottom = 0, Right = 0, Top = 1730 };
                btn7.Margin = new Thickness() { Left = 654, Bottom = 0, Right = 0, Top = 1735 };
                btn8.Margin = new Thickness() { Left = 750, Bottom = 0, Right = 0, Top = 1730 };
                btn9.Margin = new Thickness() { Left = 858, Bottom = 0, Right = 0, Top = 1730 };
                btn10.Margin = new Thickness() { Left = 960, Bottom = 0, Right = 0, Top = 1730 };
